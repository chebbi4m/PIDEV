...
public class Colis {
    ...
    public Colis(String ref, int anInt, int anInt1, int anInt2, int anInt3, boolean aBoolean, boolean aBoolean1, String depart, String destination, String etat_colis, String zone, boolean aBoolean2, int anInt4, int anInt5, String nom_partenaire) {
    }
