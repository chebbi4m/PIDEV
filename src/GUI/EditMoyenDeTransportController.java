    ...
    public class EditMoyenDeTransportController implements Initializable {
        ...
        @FXML
        private ComboBox<Livreur> livreurIdCombo;
        @FXML
        private VBox form;
        ...
        public void initialize(URL location, ResourceBundle resources) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Livreur livreur = new Livreur(id, nom, prenom, null, 0, null, null, null, null, 0, null, null);
        ...
        public void setSelectedMdt(MoyenDeTransport selectedMdt) {
            ...
            for (Livreur livreur : livreurIdCombo.getItems()) {
        ...
        private void handleSaveButtonClicked() {
            ...
            Livreur selectedLivreur = livreurIdCombo.getSelectionModel().getSelectedItem();
