...
public class ReclamationService {
    ...
    public void ajouterReclamation(reclamation reclamation) throws SQLException {
        ...
        String query = "SELECT nom, prenom FROM livreur WHERE id = ?";
        ...
        try {
            PreparedStatement ste = myconn.prepareStatement(
                    "INSERT INTO reclamation (text, personne_reclamé, type_reclamation, date, id_client, ref ) VALUES (?, ?, ?, ?, ?, ?)");
                    ste.setString(1, reclamation.getText());
                    ste.setString(2, livreur_name);
    ...
    public List<reclamation> afficherReclamation() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                String personne_reclame = resultSet.getString("personne_reclamé");
                ...
                reclamation reclamation = new reclamation(id, text, personne_reclame, type_reclamation, date_reclamation, id_client, ref_colis);
    ...
    public List<reclamation> afficherReclamationByLogin(String login) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                int id_client = resultSet.getInt("id_client");
                String text = resultSet.getString("text");
                int personne_reclame = resultSet.getInt("personne_reclamé");
